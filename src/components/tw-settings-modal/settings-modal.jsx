    ...
    <div className={styles.setting}>
        <div>
            ...
            <p>
                <FormattedMessage
                    // eslint-disable-next-line max-len
                    defaultMessage="Stores the selected settings in the project so they will be automatically applied when BubbleWrap loads this project. Warp timer and disable compiler will not be saved."
